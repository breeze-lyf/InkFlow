...
const ICONS = {
  ...
  collapseAll: '<svg viewBox="0 0 16 16" fill="none"><path d="M3.5 4.5L8 9l4.5-4.5M3.5 9.5L8 14l4.5-4.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  expandAll: '<svg viewBox="0 0 16 16" fill="none"><path d="M3.5 6.5L8 2l4.5 4.5M3.5 11.5L8 7l4.5 4.5" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
};
